...
\usepackage{tabularx} % Make sure this is in your preamble (main.tex)
...
\includepdf{images/cover-sheet.pdf}

\include{chapters/1_confidentiality}
\include{chapters/2_acknowledgment}
\include{chapters/3_disclaimer-oral-exam}
\include{chapters/4_abstract}
\include{chapters/5_extended_abstract}
\tableofcontents\newpage
\listoffigures\newpage
\listoftables\newpage
\include{chapters/6_list_of_acronyms}
\listoflistings\newpage
...
\include{chapters/7_introduction}
\include{chapters/8_chapter_preliminaries}
\include{chapters/8_chapter_user_recommendation}

\include{chapters/8_chapter_recruiter}
\include{chapters/8_chapter_congestion}
\include{chapters/8_chapter_experiments}
\include{chapters/9_conclusion}
\include{chapters/10_future-work}
%\include{chapters/11_ethical-reflection}
